# ERRORS (bugs)
# 3 types => syntex errors / runtime error / logic error
...
try:
    ...
    print("กรุณากรอกอายุเป็นเลขจำนวนเต็ม เช่น 20")
...
# raise ใช้สำหรับ ส่งให้ Python สร้าง Exception นั้นเอง เมื่อข้อมูลหรือสถานการณ์ไม่เป็นไปตาม
# แม้คำสั่งนั้นจะไม่ผิดไวยากรณ์และ Python ยังทำงานต่อได้ตามปกติก็ตาม

try:
    score = float(input("กรอกคะแนน 0-100: "))

    if not 0 <= score <= 100: #score >= 0 and score <= 100 เขียนในโปรแกรมอื่น
...
finally: #ทำทุกครั้งในตอนจบการทำงาน
